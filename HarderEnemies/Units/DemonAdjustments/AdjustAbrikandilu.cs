    ...
    internal class AdjustAbrikandilu {
        ...
        private static void AbrikandiluBuffs() {
            ...
            foreach (BlueprintUnit thisUnit in Demons.DemonAbrikandiluList) {
                thisUnit.m_AddFacts = thisUnit.m_AddFacts.AppendToArray(Abilities.HasteBuff.ToReference<BlueprintUnitFactReference>());
            }
            HEContext.Logger.LogHeader("Updated Abrikandilu");
        }
